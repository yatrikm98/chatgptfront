...
const Sidebar = ({ onClose }) => {
    ...
    // console.log(conversationList,'Conversation List')
    const [page, setPage] = useState(1)
    const [manuallyAddedConversation, setManuallyAddedConversation] = useState(0)
    ...
    useEffect(() => {
        const fetchConversationList = async () => {
            ...
            setConvsersationList([...conversationList, ...data])
        }
    ...
    useEffect(() => {
        if (value) {
            setConvsersationList(prev => [data, ...prev])
            setManuallyAddedConversation(manuallyAddedConversation + 1)
    ...
    const groupByDate = groupConversationByDate(conversationList);
    const renderedData = Object.entries(groupByDate).map((data, index) => {
        return <ConversationListItem data={data} key={index} onRouteChange={handleRouteChange} />
    })
    ...
    return (
        <div className="sidebarmaindiv">
            <div className='iconssidebar'>
                <span className='closesidebar' onClick={onClose}>
